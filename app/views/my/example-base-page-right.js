    ...
    function ExamplePage() {
        ...
        _this.on("navigatingTo", function (args) {
            if (!_this.sidedrawer) {
                ...
                var menuPath = file_system_1.knownFolders.currentApp().path + "/views/my/example-menu-right.xml";
                var menufragment = builder.load(menuPath, require("./example-menu-right"));
