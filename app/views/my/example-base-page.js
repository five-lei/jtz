...
var ExamplePage = (function (_super) {
    ...
    function ExamplePage() {
        ...
        _this.on("navigatingTo", function (args) {
            if (!_this.sidedrawer) {
                ...
                var menuPath = file_system_1.knownFolders.currentApp().path + "/views/my/example-menu.xml";
    ...
    ExamplePage.prototype.onLoaded = function () {
        ...
        btn1.on("tap", function () {
                    ...
                    _this.sidedrawer.showDrawer("1");
                    cache.set('currentPhoto','idNoPhotoFront');
        });
        ...
        btn2.on("tap", function () {
                    ...
                    cache.set('currentPhoto','idNoPhotoBack');
        });
        ...
        btn3.on("tap", function () {
                    ...
                    _this.sidedrawer.gesturesEnabled = true;
                    _this.sidedrawer.showDrawer();
                    cache.set('currentPhoto','idNoPhotoHand');
        });
