...
var MoreBindingSelectedPage = (function (_super) {
    __extends(MoreBindingSelectedPage, _super);
    function MoreBindingSelectedPage() {
        ...
        _this.on("navigatingTo", function (args) {
            if (!_this.sidedrawer) {
                ...
                var menuPath = file_system_1.knownFolders.currentApp().path + "/views/walletDeposit/addBankCard/filter-options.xml";
    ...
    MoreBindingSelectedPage.prototype.onLoaded = function () {
        var _this = this;
        var page=_this.page;
        _super.prototype.onLoaded.call(this);
        // prof.stopCPUProfile("example");
        prof.stop("example");
        var filterButton=page.getViewById("moreSelectedMenuBtn");
    ...
    return MoreBindingSelectedPage;
}(pages.Page));
exports.MoreBindingSelectedPage = MoreBindingSelectedPage;
