...
//     function Session(title, text, image, isFavourite, cssClass, id) {
...
//         configurable: true
//     });
//     Object.defineProperty(Session.prototype, "text", {
//         get: function () {
//             return this.get('_text');
//         },
//         set: function (value) {
//             this.set('_text', value);
//         },
//         enumerable: true,
//         configurable: true
//     });
...
//
//     /*分享*/
//     Session.prototype.articleShare =function () {
//         var _this = this;
...
//                         this._lists.push(new Session(contentTmp[i].title, contentTmp[i].describe, contentTmp[i]['aPicture']['path'], contentTmp[i].collection), contentTmp[i].id);
//                         content.push(contentTmp[i]);
//                     }
//                     console.dump(this._lists+'```````````1')
...
var articleListViewModel = (function (_super) {
    ...
    articleListViewModel.prototype.initDataItems = function (first, more, page) {
        if(more == true){
            ...
            //     alert("无更多教程");
            //     if(page){
            //         page.getViewById("article-view").notifyPullToRefreshFinished();
            //         page.getViewById("article-view").notifyLoadOnDemandFinished();
            //     }
            //     return;
            // }
            //加载更多
        ...
        var qureyParams={
            "name": "articleController.articleFind",
            "args": [{"first":first,"rows":10},{"tagName":"家具学院"}]
        };
        api.call(config.apiUrl,qureyParams).ok((data)=>{
            try{
                var str = JSON.stringify(data.result.content);
