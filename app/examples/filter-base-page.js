    ...
    function ExamplePage() {
        ...
        _this.on("navigatingTo", function (args) {
            if (!_this.sidedrawer1) {
                ...
                var menuPath = file_system_1.knownFolders.currentApp().path + "/examples/filter-menu.xml";
            ...
            if (!_this.sidedrawer2) {
                var root = _this.content;
                var originalRootBindingContext = root.bindingContext;
                var menuPath = file_system_1.knownFolders.currentApp().path + "/examples/timer-menu.xml";
            ...
            if (!_this.sidedrawer3) {
                var root = _this.content;
                var originalRootBindingContext = root.bindingContext;
                var menuPath = file_system_1.knownFolders.currentApp().path + "/examples/state-menu.xml";
