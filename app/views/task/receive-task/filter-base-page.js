...
var SignTypeSelectedPage = (function (_super) {
    __extends(SignTypeSelectedPage, _super);
    function SignTypeSelectedPage() {
        ...
        _this.on("navigatingTo", function (args) {
            if (!_this.sidedrawer) {
                ...
                var menuPath = file_system_1.knownFolders.currentApp().path + "/views/task/receive-task/filter-options.xml";
    ...
    SignTypeSelectedPage.prototype.onLoaded = function () {
        var _this = this;
        var page=_this.page;
        _super.prototype.onLoaded.call(this);
        // prof.stopCPUProfile("example");
        prof.stop("example");
        var filterButton=page.getViewById("moreSelectedType");
    ...
    return SignTypeSelectedPage;
}(pages.Page));
exports.SignTypeSelectedPage = SignTypeSelectedPage;
